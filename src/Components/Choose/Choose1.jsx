...
const Choose1 = () => {
    ...
    const mainContent = {
        subTitle:'Best Brand Solution',
        title:'Solusi Terbaik untuk Brand Masa Kini',
        Content:'Kami memahami bahwa setiap brand memiliki tantangan unik dalam menjaga keaslian dan membangun kepercayaan. Karena itu, kami menghadirkan solusi digital yang fleksibel dan terpercaya untuk membantu brand naik level dalam era digital.',
